...
class Upload
{
   ...
   */
    ...
    private $error;
    private $new_name_without_hash = false;
   ...
   */
    ...
    public function xml()
    {
        ...
        array_push($this->allowed, 'text/plain');
        return $this;
    }
   ...
   */
    ...
    private function validMimeAndType($file = null)
    {
        ...
        if ($file != null) {
            ...
            if (!in_array($file['type'], $this->allowed) || (!in_array($mime, $this->allowed))) {
        ...
        if (!in_array($this->file['type'], $this->allowed) || (!in_array($mime, $this->allowed))) {
   ...
   */
    ...
    public function newName($name = null)
    {
        if ($name != null) {
            $this->new_name_file = $name;
            $this->new_name_without_hash = true;
            return $this;
        }
        $this->new_name_without_hash = false;
        return $this;
    }
   ...
   */
    ...
    private function setNewName($file = null)
    {
        ...
        if ($this->new_name_without_hash) {
            $ext = pathinfo($this->file['name']);
            $this->new_name_file = $this->new_name_file . '.' . $ext['extension'];
        } else {
            if ($file != null) {
